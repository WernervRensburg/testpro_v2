    ...
    <>
      <div className="flex justify-center">
        <div className="grid grid-cols-1">
          ...
          <div className="w-full max-w-7xl relative justify-center border border-red-700">
            <img src="https://placehold.co/3000x2000" alt="temporary-image" className="w-full h-auto" loading="lazy" />
